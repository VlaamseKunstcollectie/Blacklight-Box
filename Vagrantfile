...
require_relative 'lib/blacklightbox/vagrant'

# Absolute paths on the host machine.
host_blacklightbox_dir = File.dirname(File.expand_path(__FILE__))
host_project_dir = host_blacklightbox_dir
host_config_dir = ENV['BLACKLIGHTBOX_CONFIG_DIR'] ? "#{host_project_dir}/#{ENV['BLACKLIGHTBOX_CONFIG_DIR']}" : host_project_dir

# Absolute paths on the guest machine.

# @todo

blacklightbox_env = ENV['BLACKLIGHTBOX_ENV'] || 'vagrant'

default_config_file = "#{host_blacklightbox_dir}/default.config.yml"
...
vconfig = load_config([
  ...
  "#{host_config_dir}/#{blacklightbox_env}.config.yml",
  "#{host_config_dir}/local.config.yml"
])

# Verify version requirements.
Vagrant.require_version ">= #{vconfig['blacklightbox_vagrant_version_min']}"
