...
def require_ansible_version(requirement)
  ...
  raise_message "You must install an Ansible version #{requirement} to use this version of Blacklight Box."
end
...
def get_default_post_up_message(vconfig)
  'Your Blacklight VM Vagrant box is ready to use!'\
   "\n Visit https://github.com/projectblacklight/blackligt for instructions on how to"\
